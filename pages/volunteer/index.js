...
Page({
    ...
    common.volunteerPage.list(_this);
  ...
  close: function () {
	...
	detailTap:function(e){
	    ...
	    wx.navigateTo({
		  url: '/pages/volunteerDetail/index?id='+id
		});
	},
  ...
  mychild: function (e) {
	...
	delTap:function(e){
		var _this=this;
		var id=e.currentTarget.dataset.id;
		common.volunteerPage.del(_this,id);
	},

	//重命名
	volunteerPopTap:function(e){
		var _this=this;
		var id=e.currentTarget.dataset.id;
		_this.data.volunteerPop ? _this.setData({id:0,volunteerPop:false}):_this.setData({id:id,volunteerPop:true});
	},
	...
	volunteerTap:function(){
		var _this=this;
		common.volunteerPage.edit(_this);
  },
  vipclose: function () {
