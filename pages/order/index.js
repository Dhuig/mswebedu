...
Page({
  ...
  close: function () {
	...
	checkboxTap:function(e){
		var _this=this;	
	    e.target.dataset.checked==1 ? _this.setData({checked:0}) : _this.setData({checked:1});
	},
	...
	delTap:function(e){
		...
		var arr=_this.data.quantity;
		if(arr[index]>0){
	        arr[index]=arr[index]-1;

	        arr[2]=arr[2]+1;

			_this.setData({quantity:arr});
		}
	},
	...
	queryTap:function(){
		 var _this=this;
		 common.schoolPage.querySubmit(_this,1);
	},
